...
export function AssetCart({ items, onRemove, isOpen, onClose, onCheckout, getOrder }: AssetCartProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
                ...
                items.map((item) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex items-center gap-3 p-4 bg-navy-50/50 rounded-2xl border border-navy-100/30 group"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[9px] font-bold text-primary uppercase tracking-widest mb-0.5 truncate">
                          {item.category}
                        </p>
                      ...
                      <Button
                        ...
                        className="text-red-300 hover:text-red-500 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-all rounded-xl shrink-0"
                      >
