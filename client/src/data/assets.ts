...
export const assetCategories: AssetCategory[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'tshirt-artistic-front', name: '04 · Destaque: Mãos Dadas', config: { color: 'purple', view: 'front', layout: 'artistic-serif' } },
      { id: 'tshirt-badge-front', name: '06 · Ritmos Melódicos', config: { color: 'navy', view: 'front', layout: 'badge-circle' } },
      { id: 'tshirt-vertical-front', name: '07 · Tipografia Vertical Light', config: { color: 'navy', view: 'front', layout: 'vertical-modern' } },
      { id: 'tshirt-oversized-front', name: '08 · Vertical Impact (Split)', config: { color: 'white', view: 'front', layout: 'oversized-impact' } },
      { id: 'tshirt-boxed-front', name: '09 · Vertical em Bloco', config: { color: 'navy', view: 'front', layout: 'boxed-lockup' } },
